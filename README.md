...
**前言：**下载后的数据集文档目录中包含train.csv&train_images文件夹，train_images中存放训练用的 12,568 张图像，本项目随机选取1300张图像进行训练（图像选取见1.2节），train.csv文件包含了图像信息，如下所示：![Figure_5](.\03-pic\1.png)
...
<img src=".\03-pic\10.png" alt="P_curve width=" style="zoom:60%;" />
